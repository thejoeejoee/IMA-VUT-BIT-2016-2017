...
Nejdříve musíme zjistit účelovou funkci, u které funkční hodnota je vzdálenost mezi bodem \(A\) a bodem ležícím na funkci \(f\).
Následně budeme hledat minima naši účelové funkce \(U\). A globální minimum funkce \(U\) bude souřadnice na ose \(x\) hledaného bodu.
...
Určíme si účelovou funkce \(U\), jejiž funkční hodnoty nabývají hodnoty vzdálenosti mezi body A a bodem ležící na funkci \(f\).
...
Ze zadání vyplývá, že máme najít takové \(x\), jehož funkční hodnota je nejmenší, respektive nejkratší vzdálenost. \\
